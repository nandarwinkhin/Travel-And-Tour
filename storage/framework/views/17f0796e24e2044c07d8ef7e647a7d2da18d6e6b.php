    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register as an Organization</div>
                        ...
                        <div class="form-group" style="width: 500x; height: 200px; ">
                            ...
                            <label for="name" class="col-md-4 control-label">Profile picture</label>
                                <div style="background-color: lightgrey;width:150px; height:150px;">
                                    ...
                                    <input type="file" class="custom-file-input" id="uploadFile" name="ImageForOrg" style="width: 150px; height: 150px; "/> 
                                </div>
                            </div>
                        </div>
