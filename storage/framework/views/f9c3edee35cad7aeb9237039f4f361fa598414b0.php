...
<div class="card card-body bg-light container mt-5 col-md-offset-2 col-md-8">
        ...
        <br>
    <h4 style="margin-left:80px;">Email - <?php echo e($user->email); ?></h4>
    <h4 style="margin-left:80px;">Phone - <?php echo e($user->phone); ?></h4>
    <br>
...
<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    <div class="card card-body bg-light container mt-5 col-md-offset-2 col-md-8">
        ...
        <div class="form-row"><img src="http://localhost/TravelAndTour/public/uploades/<?php echo e($user->photo); ?>" width='80' height='80' style='border-radius: 50%;'> 
        <h3 style='margin-top:15px;margin-left:10px;'><?php echo e($user->name); ?></h3>
    </div>
...
<?php $__currentLoopData = $trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    <div class="card card-body bg-light container mt-5 col-md-offset-2 col-md-8">
        ...
        <div class="form-row"><img src="http://localhost/TravelAndTour/public/uploades/<?php echo e($user->photo); ?>" width='80' height='80' style='border-radius: 50%;'> 
        <h3 style='margin-top:15px;margin-left:10px;'><?php echo e($user->name); ?></h3></div>
